				...
				public void onClick(View v) {
					...
					if (((CheckBox) v).isChecked()) {
						try {
							...
							Registration_step3_Activity.obj_restaurant_app.put(
									position + "", str_checked_creditcard_Name);
							System.out
							...
							// }
							// try {
							// str_selected_cads = str_selected_cads.substring(
							// 0, str_selected_cads.length() - 1);
							//
							// System.out.println("!!!!str_selected_cads"
							// + str_selected_cads);
							//

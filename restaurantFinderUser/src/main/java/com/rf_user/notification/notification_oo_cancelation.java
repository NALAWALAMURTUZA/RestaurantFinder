...
public class notification_oo_cancelation extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_oo_cancelation);
            ...
            if(obj_Detail.has("data")){
                ...
                for(int i=0;i < array.length();i++){
                   ...
                   // str_offer_uid=obj.getString("applied_offers");
                    //System.out.println("offerid=="+str_offer_uid);
                ...
                if(cart.length()!=0){
                    notification_cart_adapter = new notification_cart_adapter(
                            notification_oo_cancelation.this, cart);
    ...
    private void setlistner() {
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in = new Intent(notification_oo_cancelation.this, FindRestaurant.class);
                startActivity(in);
            }
        });
    }

...
public class notification_tg_confirmation extends Activity {
    ...
    private void setvalue() {
        try {
            ...
            txt_order_id.setText(getResources().getString(R.string.noti_Booking)+obj_Detail.getString("tg_order_uid"));
    ...
    private void setlistner() {
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in=new Intent(notification_tg_confirmation.this, FindRestaurant.class);
                startActivity(in);
            }
        });
    }

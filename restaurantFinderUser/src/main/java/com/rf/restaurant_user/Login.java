...
import static com.rf.restaurant_user.CommonUtilities.DISPLAY_MESSAGE_ACTION;
import static com.rf.restaurant_user.CommonUtilities.EXTRA_MESSAGE;
import static com.rf.restaurant_user.CommonUtilities.SENDER_ID;
import static com.rf.restaurant_user.CommonUtilities.TAG;
...
public void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(com.rf.restaurant_user.R.layout.login);
    /* create Object* */
    try {
...
public void initializeWidget() {
    ScrollView scrollable_contents = (ScrollView) findViewById(com.rf.restaurant_user.R.id.login_scrollview);
    getLayoutInflater().inflate(com.rf.restaurant_user.R.layout.loginscrollview_contents,
            scrollable_contents);
    Login = (TextView) findViewById(com.rf.restaurant_user.R.id.Login_textview);
    Forget_Password = (TextView) findViewById(com.rf.restaurant_user.R.id.forget_password_textview);
    admin_rest_registration_link = (TextView) findViewById(com.rf.restaurant_user.R.id.admin_rest_registration_link);
    Register = (TextView) findViewById(com.rf.restaurant_user.R.id.register_textview);
    username = (EditText) findViewById(com.rf.restaurant_user.R.id.username_edittext);
    password = (EditText) findViewById(com.rf.restaurant_user.R.id.password_edittext);
    admin_rest_registration_link
            .setText(getResources().getString(com.rf.restaurant_user.R.string.admin_rest_registration_link));
//		admin_rest_registration_link
...
public class async_init extends AsyncTask<Void, Void, Void> {
    ...
    protected void onPreExecute() {
        ...
        p.setMessage(getString(com.rf.restaurant_user.R.string.str_please_wait));
        p.setCancelable(false);
        p.setMessage(getResources().getString(com.rf.restaurant_user.R.string.str_please_wait));
        p.show();
    ...
    protected void onPostExecute(Void result) {
        ...
        try {
            ...
            if (json_success_str.equalsIgnoreCase("true")) {
                ...
                Toast.makeText(Login.this, com.rf.restaurant_user.R.string.str_No_Data_Available,
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        Toast.makeText(getApplicationContext(),
                                com.rf.restaurant_user.R.string.No_Internet_Connection,
                                Toast.LENGTH_LONG).show();
...
public boolean onCreateOptionsMenu(Menu menu) {
    ...
    getMenuInflater().inflate(com.rf.restaurant_user.R.menu.main, menu);
    return true;
}
...
class GetUserDetail extends AsyncTask<String, String, String> {
    ...
    protected void onPreExecute() {
        ...
        progressDialog.setMessage(getResources().getString(com.rf.restaurant_user.R.string.str_please_wait));
        progressDialog.show();
    }
        ...
        try {
            ...
            if (json != null) {
                ...
                if (Data_Success.equalsIgnoreCase("true")) {
                    ...
                    String message = getApplicationContext().getString(com.rf.restaurant_user.R.string.server_registered);
...
public String gcmcall() {
    ...
    if (regId.equals("")) {
        ...
        if (GCMRegistrar.isRegisteredOnServer(this)) {
            ...
            for (int i = 1; i <= MAX_ATTEMPTS; i++) {
                ...
                try {
                    displayMessage(context, context.getString(
                            com.rf.restaurant_user.R.string.server_registering, i, MAX_ATTEMPTS));

                    GCMRegistrar.setRegisteredOnServer(context, true);
                    String message = context.getString(com.rf.restaurant_user.R.string.server_registered);
            ...
            String message = context.getString(com.rf.restaurant_user.R.string.server_register_error,
                    MAX_ATTEMPTS);
            CommonUtilities.displayMessage(context, message);
        }
    }

...
public class Registration_step2_Activity extends Activity {
	...
	public static TextView rf_regi_step2_tv_dont, rf_regi_step2_cancel;
	...
	private void setlistner() {
		...
		sp_mto.setOnItemSelectedListener(new OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view,
				...
				str_mto = sp_mto.getSelectedItem().toString();
				System.out.println("str_mto" + str_mto);
				sp_index = sp_mto.getSelectedItemPosition();
...
//						"select" +" "+ sp_index, Toast.LENGTH_LONG).show();
	...
	private void initialization() {
		...
		rf_regi_step2_cancel = (TextView) findViewById(R.id.rf_regi_step2_cancel);
		...
		rf_regi_step2_cancel.setText(getResources().getString(
				R.string.rf_admin_tv_cancel));
		// *********changes
	...
	public class async_regi_step2 extends AsyncTask<Void, Void, Void> {
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				// obj_restaurant_app.put("mto", sp_mto.getSelectedItem()
				// .toString().substring(0, 1));

				obj_restaurant_app.put("mto", sp_index+"");
			...
			try {
				...
				if (jsonSuccessStr.equalsIgnoreCase("true")) {
					...
					if (Data != null) {
						...
						Registration_Tablayout_Activity.tab.setCurrentTab(2);
	...
	public void onBackPressed() {
		...
		if (cd.isConnectingToInternet()) {
			...
			Registration_Tablayout_Activity.tab.setCurrentTab(0);
		} else {
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (LanguageConvertPreferenceClass.getlanguage(
				Registration_step2_Activity.this).equalsIgnoreCase("ro")) {
			LanguageConvertPreferenceClass.setlanguage(
					Registration_step2_Activity.this, "ro");
		} else if (LanguageConvertPreferenceClass.getlanguage(
				Registration_step2_Activity.this).equalsIgnoreCase("en")) {
			LanguageConvertPreferenceClass.setlanguage(
					Registration_step2_Activity.this, "en");
		}
		...
		try {
			if (!sourceFileUri.equalsIgnoreCase("")
				...
				if (!sourceFile.isFile()) {
					...
					System.out.println("!!!!pankaj_sakariya_file_upload_uri_if"
							+ getString(R.string.str_uploadFile)
					...
					System.out
							.println("!!!!pankaj_sakariya_file_upload_uri_else"
									+ getString(R.string.str_uploadFile)
									+ getString(R.string.str_Source_File_not_exist));
				}

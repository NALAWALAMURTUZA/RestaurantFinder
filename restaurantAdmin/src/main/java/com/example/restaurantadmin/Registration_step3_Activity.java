...
import com.restaurantadmin.adapter.CreditCardsAdapter;
import com.restaurantadmin.adapter.DBAdapter;
import com.restaurantadmin.adapter.ServiceAdapter;
...
public class Registration_step3_Activity extends Activity {
	...
	public static TextView rf_regi_step3_txv_cancel;
...
//	}
		...
		rf_regi_step3_btn_continue
				.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						// TODO Auto-generated method stub
						boolean flag = true;
						String select_cards=getResources().getString(R.string.str_select_cards);
						String select_services=getResources().getString(R.string.str_Select_Service);
						if (rf_txv_service.getText().toString()
								.equalsIgnoreCase(select_services)) {
							flag = false;
							Toast.makeText(Registration_step3_Activity.this,
									getString(R.string.str_Select_Service),
									Toast.LENGTH_LONG).show();
						}
						if (txv_credit_cards.getText().toString()
								.equalsIgnoreCase(select_cards)) {
							flag = false;

							Toast.makeText(Registration_step3_Activity.this,
									getString(R.string.str_select_cards),
									Toast.LENGTH_LONG).show();
						}
						// ********************************************
						// glass wine*
	...
	private void initialization() {
		...
		rf_regi_step3_txv_cancel = (TextView) findViewById(R.id.rf_regi_step3_cancel);
		rf_regi_step3_txv_cancel.setText(R.string.str_rf_regi_step3_calcel);
	...
	public void ServiceDialog() {
		...
		ServiceDialog.setTitle(getResources().getString(R.string.str_rf_regi_step3_popup_title));
		...
		try {
...

			{
				...
				Toast.makeText(Registration_step3_Activity.this,
						getString(R.string.str_Service_not_available),
						Toast.LENGTH_LONG).show();
			}
			ServiceDialog.show();
	...
	public void CreditCardsDialog() {
		...
		CreditCardDialog.setTitle(getResources().getString(R.string.str_rf_regi_step3_popup_creditcards));
		...
		try {
...

			{
				...
				Toast.makeText(Registration_step3_Activity.this,
						getString(R.string.str_CreditCards_not_available),
						Toast.LENGTH_LONG).show();
			}
		...
		protected Void doInBackground(Void... params) {
			...
			try {
				...
				if (obj_restaurant_app.length() != 0) {
						...
						if (obj_restaurant_app.has(i + "")) {
							try {
								str_selected_cards += obj_restaurant_app.get(i
										+ "")
										+ ",";
								System.out.println("comasepratecards"
										+ str_selected_cards);
							} catch (JSONException e) {
								// TODO Auto-generated catch block
								e.printStackTrace();
					...
					try {
						str_selected_cards = str_selected_cards.substring(0,
								str_selected_cards.length()-1);
						System.out.println("comasepratecardsafterloop"
								+ str_selected_cards);
			...
			try {
				...
				try {
					...
					String str_response = con.connection(Registration_step3_Activity.this,
			...
			try {
				...
				if (jsonSuccessStr.equalsIgnoreCase("true")) {
					...
					if (Data != null) {
						...
						Registration_Tablayout_Activity.tab.setCurrentTab(3);

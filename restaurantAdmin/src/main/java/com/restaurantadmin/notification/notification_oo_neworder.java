...
public class notification_oo_neworder extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_notification_oo_neworder);
    ...
    private void setvalue() {
        try {
            if(obj_Detail.has("cart")) {
                ...
                if(cart.length()!=0){
                    ...
                    notification_cart_adapter = new notification_cart_adapter(
                            notification_oo_neworder.this, cart);
            ...
            txt_time.setText(getResources().getString(R.string.oo_ordertime)+obj_Detail.getString("delivery_schedule_from"));
            ...
            if(obj_Detail.getString("delivery_ok").equalsIgnoreCase("1")) {
                ...
                txv_delivery_charge.setText(Global_variable.Categories_sr + " " + "0.00");
            }
    ...
    private void setlistner() {
        btn_ok.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent in=new Intent(notification_oo_neworder.this, Login_Activity.class);
                startActivity(in);
//                finish();
            }
        });
    ...
    public void onNewIntent(Intent intent) {
       ...
       // if (extras != null) {
            try {
                ...
                System.out.println("obj_detail12356==" + obj_Detail);
            } catch (JSONException e) {
                e.printStackTrace();
            }
